...
public class TelaCadastroUsuario extends Tela {	
	...
	private JComboBox combo_cidade;
	private JTextField field_cep, field_email, field_cpf, field_nome, field_rua, field_telefone, field_numero, field_bairro;
	private JPasswordField field_senha;	
	private JComboBox combo_vinculo;
	private JLabel label_nomeFuncionario, jLabel10, jLabel11, jLabel12, jLabel14, jLabel16, jLabel17, jLabel18, jLabel3, jLabel4, jLabel5, jLabel6, jLabel7, jLabel8, jLabel9;
	private JSeparator jSeparator1, jSeparator2, jSeparator3;
	private JPanel telaCadastro;
	//----------------------------------------
	private ControleCadastro controle;	
	private String nome, vinculo, cpf, email, telefone, rua, numero, bairro, cep, cidade, senha, matricula;
	...
	private void iniciarComponentes() {
		...
		telaCadastro.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Cadastrar usuario"));
		...
		jLabel17.setText("Identificacao");
		...
		combo_vinculo.setModel(new javax.swing.DefaultComboBoxModel(new String[] {"Professor", "Aluno", "Servidor"}));

		combo_cidade.setModel(new javax.swing.DefaultComboBoxModel(new String[] { 
																				...
																				.addGroup(telaCadastroLayout.createSequentialGroup()
																						...
																						.addGroup(telaCadastroLayout.createSequentialGroup()
																								...
																								.addGroup(telaCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
																										...
																										.addComponent(field_nome, javax.swing.GroupLayout.PREFERRED_SIZE, 483, javax.swing.GroupLayout.PREFERRED_SIZE)))))
																										.addGroup(telaCadastroLayout.createSequentialGroup()
																												.addContainerGap()
																												.addGroup(telaCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
																														.addGroup(telaCadastroLayout.createSequentialGroup()
																																...
																																.addGroup(telaCadastroLayout.createSequentialGroup()
																																		...
																																		.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
																																		.addComponent(field_bairro, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE)
																																		.addGap(134,134, 134)
																																		.addComponent(jLabel16)
																																		.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
																																		.addComponent(combo_cidade, javax.swing.GroupLayout.PREFERRED_SIZE, 232, javax.swing.GroupLayout.PREFERRED_SIZE)
																																		.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
																																		...
																																		.addGroup(telaCadastroLayout.createSequentialGroup()
																																				...
																																				.addGroup(telaCadastroLayout.createSequentialGroup()
																																						...
																																						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
																																						.addComponent(field_senha, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
																																					.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
	...
	private void confirmarMouseClicked(java.awt.event.MouseEvent evt) {                                          
		...
		vinculo= (String) combo_vinculo.getSelectedItem();
		...
		bairro = (String) field_bairro.getText();
		cep = field_cep.getText();
		cidade = (String) combo_cidade.getSelectedItem();
		senha = field_senha.getText();

		matricula = controle.cadastrarUsuario(nome, vinculo, cpf, email, telefone, rua, numero, bairro, cep, cidade, senha);
	...
	private void finalizarCadastro(){
		...
		montarNovaTela();
		JOptionPane.showMessageDialog(null,"Cadastro realizado com sucesso!\nMatricula do novo usuario: " + matricula);
	}
