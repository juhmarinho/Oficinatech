...
public class TelaBuscaBibliotecario  extends TelaBusca{
	...
	protected void addBuscarPor() {
		...
		buscarPor.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "  ", "Obra", "Exemplar"}));
